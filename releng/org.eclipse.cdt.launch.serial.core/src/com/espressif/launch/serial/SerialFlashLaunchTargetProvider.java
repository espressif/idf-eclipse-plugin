 ...
 *******************************************************************************/
package com.espressif.launch.serial;
...
public class SerialFlashLaunchTargetProvider implements ILaunchTargetProvider {
	...
	public static final String TYPE_ID = "com.espressif.launch.serial.core.serialFlashTarget"; //$NON-NLS-1$

	public static final String ATTR_SERIAL_PORT = "com.espressif.launch.serial.core.serialPort"; //$NON-NLS-1$
