...
//			Fixture.whenChangeLaunchTargetBackToESP32();
	...
	private static class Fixture {
		...
		private static final TargetPort[] TARGETS = new TargetPort[] {
				...
				new TargetPort("esp32c61", "/dev/ttyUSB6 CP2102N USB to UART Bridge Controller"),
				new TargetPort("esp32c5", "/dev/ttyUSB4 CP2102N USB to UART Bridge Controller"),
				...
				new TargetPort("esp32s3", "/dev/ttyUSB0 CP2102N USB to UART Bridge Controller"),
				new TargetPort("esp32c6", "/dev/ttyUSB2 CP2102N USB to UART Bridge Controller")
		};
