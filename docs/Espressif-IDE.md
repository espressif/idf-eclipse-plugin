...
## Downloads
### Espressif-IDE v2.9.1 (Latest stable)

| OS  | Download |
| ------------- | ------------- |
| Windows  | <a href ="https://dl.espressif.com/dl/idf-eclipse-plugin/ide/Espressif-IDE-2.9.1-win32.win32.x86_64.zip">Espressif-IDE-2.9.1-win32.win32.x86_64.zip</a>  |
| macosx | <a href ="https://dl.espressif.com/dl/idf-eclipse-plugin/ide/Espressif-IDE-macosx-cocoa-x86_64-v2.9.1.dmg">Espressif-IDE-macosx-cocoa-x86_64-v2.9.1.dmg</a>  |
| macosx aarch64| <a href ="https://dl.espressif.com/dl/idf-eclipse-plugin/ide/Espressif-IDE-macosx-cocoa-aarch64-v2.9.1.dmg">Espressif-IDE-macosx-cocoa-aarch64-v2.9.1.dmg</a>  |
| linux | <a href ="https://dl.espressif.com/dl/idf-eclipse-plugin/ide/Espressif-IDE-2.9.1-linux.gtk.x86_64.tar.gz">Espressif-IDE-2.9.1-linux.gtk.x86_64.tar.gz</a>  |
