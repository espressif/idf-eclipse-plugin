...
-  需要进行一些电气连接工作，可参考这篇面向 ESP32-S2 开发板的 `指南 <https://blog.espressif.com/dfu-using-the-native-usb-on-esp32-s2-for-flashing-the-firmware-b2c4af3335f1>`_。USB 外设所需的连接可参见下表。
