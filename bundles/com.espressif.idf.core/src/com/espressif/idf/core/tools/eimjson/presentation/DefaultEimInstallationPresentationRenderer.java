...
/**
 * Schema-neutral presentation renderer. V2 installations always have
 * {@link InstallationStatus#FINISHED}; V3 adds lifecycle statuses from JSON.
 */
public final class DefaultEimInstallationPresentationRenderer implements EimInstallationPresentationRenderer
{
	@Override
	public EimInstallationPresentation render(EimInstallationModel installation, boolean isActive,
			boolean isSettingUp)
	{
		if (isSettingUp)
		{
